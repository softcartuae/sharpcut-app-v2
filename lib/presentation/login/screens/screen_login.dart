...
class _ScreenLoginState extends State<ScreenLogin> {
                ...
                child: Tooltip(
                  ...
                  richMessage: TextSpan(
                    children: [
                      ...
                      TextSpan(text: 'Build Date: ${BuildConfig.buildDate}\n'),
                      TextSpan(
  ...
  String _getEnvironment() {
    if (ApiClient.baseUrl == ApiClient.productionBaseUrl) {
      return 'Production';
    } else if (ApiClient.baseUrl == ApiClient.developmentBaseUrl) {
      return 'Staging';
    }
