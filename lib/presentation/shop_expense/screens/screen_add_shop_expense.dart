...
class ScreenAddShopExpense extends StatefulWidget {
  final StaffModel staff;
  const ScreenAddShopExpense({super.key, required this.staff});

  @override
  State<ScreenAddShopExpense> createState() => _ScreenAddShopExpenseState();
}

class _ScreenAddShopExpenseState extends State<ScreenAddShopExpense> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<ShopExpenseCubit, ShopExpenseState>(
      listener: (context, state) {
        if (state is ShopExpenseSubmitted) {
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            BlocBuilder<ShopExpenseCubit, ShopExpenseState>(
                              builder: (context, state) {
                                return GestureDetector(
                                  onTap:
                                      _addedExpenses.isEmpty ||
                                          state is ShopExpenseSubmitting
                                      ? null
                                      : () {
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        if (state is ShopExpenseSubmitting)
                                          const Padding(
